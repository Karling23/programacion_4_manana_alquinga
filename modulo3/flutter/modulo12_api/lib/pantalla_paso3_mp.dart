...
class PantallaPaso3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paso 3 · Catálogo General API'),
              ...
              return Card(
                child: ListTile(
                  leading: CircleAvatar(
                    backgroundColor:
                        p.activo ? Colors.orange[100] : Colors.grey[200],
                    child: Text(
                      p.id.toString(),
                      style: TextStyle(
                        color: p.activo ? Colors.orange[800] : Colors.grey,
                  ...
                  title: Text(p.nombre),
                  subtitle: Text(p.categoria ?? 'Accesorios / Equipamiento'),
                  trailing: Column(
