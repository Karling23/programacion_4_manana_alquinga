...
class PantallaPaso2Users extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paso 2 · Asesores de Ventas'),
            ...
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    Chip(
                      label: Text('${users.length} Asesores Disponibles'),
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return ListTile(
                      ...
                      leading: CircleAvatar(
                        backgroundColor: Colors.orangeContainer ?? Colors.orange.shade100,
                        child: Text(user.id.toString(), style: const TextStyle(fontWeight: FontWeight.bold)),
                      ),
                    );
                  },
                ),
